...
progress_mod = lazy_module("rich.progress")
Progress = progress_mod.Progress
SpinnerColumn = progress_mod.SpinnerColumn
BarColumn = progress_mod.BarColumn
TextColumn = progress_mod.TextColumn
TimeRemainingColumn = progress_mod.TimeRemainingColumn
KazooClient = lazy_module("kazoo.client").KazooClient
